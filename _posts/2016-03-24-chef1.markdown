...
# <a name="attributes"></a> What is attributes?
...
## <a name="create_attribute"></a> How to create attribute?
...
# <a name="templates"></a> What is templates
...
```
## <a name="template_create"></a> How to create template?
...
## <a name="template_use"></a> How use tempalte from recipe?
...
## <a name="templates_variables"></a> How to use variables inside templates or template IoC?
